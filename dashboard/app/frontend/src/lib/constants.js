...
export const CLARITY_BANDS = [
  { max: 2, label: "Turbid", description: "Under 2 m, hard to see into the water" },
  { max: 4, label: "Moderate", description: "2 to 4 m, common for many Maine lakes" },
  { max: Infinity, label: "Clearer", description: "Over 4 m, unusually clear" },
];
